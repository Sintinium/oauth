...
public class MultiplayerDisabledScreen extends OAuthScreen {
    ...
    public void render(PoseStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        drawCenteredString(p_230430_1_, Minecraft.getInstance().font, Component.literal("Multiplayer Disabled").setStyle(Style.EMPTY.withBold(true)), this.width / 2, this.height / 2 - 40, 0xFFFFFF);
