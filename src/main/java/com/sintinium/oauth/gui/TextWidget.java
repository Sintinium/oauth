...
public class TextWidget extends Button {
    ...
    public void renderButton(PoseStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
        drawString(p_230431_1_, Minecraft.getInstance().font, this.getMessage(), this.x + this.width / 2, this.y + (this.height - 8) / 2, getFGColor() | (int) Math.ceil(this.alpha * 255.0) << 24);
    }
}
